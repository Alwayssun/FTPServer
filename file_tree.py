...
class DirTree(QTreeView):
    def __init__(self, parent=None):
        ...
        self.Open_Folder()
        self.clicked.connect(self.p)
        print('model',self.selectionModel())
    ...
    def Open_Folder(self,path = 'G:\\data_sun\\ftp'):
        ...
        self.tree.setColumnWidth(0, self.width())
        ...
        child.setIcon(0, QtGui.QIcon(self.getIcon('.py')))
